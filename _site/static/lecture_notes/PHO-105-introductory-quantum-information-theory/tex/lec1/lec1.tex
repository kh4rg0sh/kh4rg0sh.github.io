...
\begin{enumerate}
    ...
    \end{equation*}
    \item The sixth, and the last postulate, states that the wave function is symmetric for particles with integer spin, called the \highlight{bosons}, and it is antisymmetric for particles with half-integer spin, called the \highlight{fermions}. The mathematical treatment of this postulate yields the \vocab{Pauli Exclusion Principle} which states that no two identical fermions can occupy the same quantum state.
\end{enumerate}
