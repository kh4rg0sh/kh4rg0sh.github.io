...
\tcbset{
	...
	hwproblem box/.style={
		...
		boxrule=0pt,
		frame hidden,
		borderline west={4pt}{0pt}{RoyalBlue},
		colback=RoyalBlue!4,
		before skip=12pt,
		after skip=14pt,
		left=12pt,
...
\declaretheorem[style=thmtheorem,name=Problem,numberwithin=section]{problem}
\tcolorboxenvironment{problem}{problem box}
...
\tcolorboxenvironment{homework}{hwproblem box}
