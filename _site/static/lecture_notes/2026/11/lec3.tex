...
\begin{document}
\title{Lecture Notes (18th Jan, 2026)}
\date{\today}
\maketitle
...
\begin{definition}
    Given a circle $\omega$ centered at $O$ with radius $r$ and a point $P$, the \vocab{power of point $P$} is given by
    \begin{align*}
...
\begin{exercise}[IMO Shortlist 2006]
...
\begin{exercise}[IMO Shortlist 2021]
