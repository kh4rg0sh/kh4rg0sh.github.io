...
\begin{ques}
    Think about the lower bound on $T_d(n)$ in the case of a decremental, and fully dynamic algorithm.
\end{ques}

\begin{ques}
    Does there exist a dynamic algorithm for an \highlight{NP-hard} problem that lies in $\mathbf{P}$?
\end{ques}
